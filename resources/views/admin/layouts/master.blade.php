...
***********************************-->
<!-- Required vendors -->
<script src="http://waglz.aeologic.in/assets/plugins/ckeditor/ckeditor.js"></script>
<script src="https://cdn.ckeditor.com/ckeditor5/ckeditor.js">

<script data-cfasync="false" src="{{asset('backend/assets/../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{asset('backend/assets/vendor/global/global.min.js')}}"></script>
